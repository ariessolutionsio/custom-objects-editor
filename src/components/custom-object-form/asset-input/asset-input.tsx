...
const AssetInput: FC<Props> = ({ name, value = {}, onChange, touched, errors }) => {
  ...
  const handleLocalizedChange = (e: {
    target: { name: string; value: LocalizedString };
  }) => {
    const { name: fieldName, value: localizedValue } = e.target;
